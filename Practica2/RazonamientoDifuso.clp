...
(cd temperatura alta 37.8 38.5 38.8 39)             ; aproximadamente entre 38.5 y 38.8
(cd temperatura muy_alta 38.8 39.5 100 100)         ; aproximadamente mas 39.5
(cd peso bajo 0 0 50 60)                            ; aproximadamente  menos de 50
(cd peso medio 55 62 70 75)                         ; aproximadamente entre 62 y 70
(cd peso alto 70 73 80 80)                          ; aproximadamente entre 73 y 80
(cd peso muy_alto 75 100 300 300)                   ; aproximadamente más de 100
...
(cd dosis muy_alta 10 12 12 13)                     ; aprximadamente 11
(cd edad baja 0 0 20 25)                            ; aproximadamente menos de 20
(cd edad media 25 30 60 65)                         ; aproximadamente entre 30 y 60
(cd edad alta 70 75 90 100)                         ; aproximadamente entre 75 y 90
(cd edad muy_alta 95 102 105 110)                   ; aproximadamente más de 102
)
...
(regla 5 explicacion "Si la temperatura es muy alta, la dosis a aplicar es muy alta")
(regla 6 antecedente temperatura muy_alta)
(regla 6 antecedente peso medio muy_alto)
(regla 6 consecuente dosis muy_alta)
(regla 6 explicacion "Si la temperatura es muy alta y el peso es muy alto, la dosis a aplicar es muy alta")
(regla 7 antecedente temperatura alta)
(regla 7 antecedente peso medio)
(regla 7 Edad media)
(regla 7 consecuente dosis alta)
(regla 7 explicacion "Si la temperatura es alta , la edad media, el peso es medio, la dosis a aplicar es alta")
)
